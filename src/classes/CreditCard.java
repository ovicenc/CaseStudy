...
public class CreditCard {
    ...
    public CreditCard(int transaction_id, int day, int month, int year, String credit_card_no, int cust_ssn, int branch_code, String transaction_type, double transaction_value) {
